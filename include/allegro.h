...
void gui_river_water        (float x1, float y1, 
                             float x2, float y2);
void gui_river_land         (float x1, float y1, 
                             float x2, float y2);
void gui_river_smooth_water (float x1, float y1, 
                             float x2, float y2, 
                             float x3, float y3);
void gui_river_smooth_land  (float x1, float y1, 
                             float x2, float y2, 
                             float x3, float y3);
